...
//                     dataEntrega, formaEntrega ("Entrega"|"Retirada"), enderecoEntrega?,
//                     itens: [{ descricao, qtd, valorUnit, subtotal }],
//                     subtotal, desconto?, total,
//                     percentualSinal?, valorSinal?,
//                     formasPagamento, observacoes? } }
...
<div class="categoria-section">
  <div class="categoria-titulo">Detalhes da Encomenda</div>
  <div class="categoria-grid">
    <div class="cat-linha"><strong>Data de entrega/retirada:</strong> ${esc(d.dataEntrega)}</div>
    <div class="cat-linha"><strong>Forma:</strong> ${esc(d.formaEntrega)}</div>
    ${d.formaEntrega === "Entrega" && d.enderecoEntrega
      ? `<div class="cat-linha full"><strong>Endereço de entrega:</strong> ${esc(d.enderecoEntrega)}</div>`
      : ""}
  </div>
</div>
...
<div class="condicoes-section">
  ...
  <div class="condicoes-body">
    <ul>
      ${d.percentualSinal ? `<li><strong>Sinal/Entrada:</strong> ${esc(d.percentualSinal)} (${d.valorSinal}) para confirmação do pedido</li>` : ""}
